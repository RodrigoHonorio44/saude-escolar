...
import useDashboardSaudeInclusiva from '../../hooks/useDashboardSaudeInclusiva'; // Certifique-se de que o hook está na mesma pasta
      ...
      <div className="no-print flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
          {["todos", "tea", "tdah", "outros"].map(tab => (
            <button 
              ...
              className={`px-6 py-2 rounded-xl font-black text-[9px] uppercase italic transition-all whitespace-nowrap ${
                abaAtiva === tab 
      ...
      <div className="grid grid-cols-1 gap-3">
        {dadosFiltrados.length > 0 ? (
          dadosFiltrados.map(aluno => (
            <div 
              ...
              className={`bg-white rounded-[30px] border transition-all ${
                aluno.temAlergia === 'sim' ? 'border-red-200 shadow-sm shadow-red-50' : 'border-slate-100 shadow-sm'
              }`}
            >
              {/* CARD RESUMIDO */}
              <div 
              ...
              >
                ...
                <div className="flex items-center gap-3">
                    {aluno.temAlergia === 'sim' && (
                      <span className="px-3 py-1 bg-red-500 text-white rounded-full text-[8px] font-black uppercase italic">Alérgico</span>
                    )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div className="space-y-3">
                      <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100">
                        ...
                        <p className="text-[11px] font-black text-slate-800 uppercase italic leading-relaxed">
                    ...
                    <div className="flex flex-col justify-end">
                      ...
                      >
                        <GraduationCap size={16} /> Acessar Prontuário Digital
                      </button>
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center py-20 bg-slate-50 rounded-[40px] border-2 border-dashed border-slate-100">
            ...
            <p className="text-slate-300 font-black uppercase italic text-xs">Nenhum PCD localizado.</p>
          </div>
        )}
      </div>
    </div>
